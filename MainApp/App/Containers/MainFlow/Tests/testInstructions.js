    ...
    const resetAction = StackActions.reset({
      ...
      actions: [
        NavigationActions.navigate({
          routeName: "mcqScreen",
          params: { item: this.state.data, quizActivity: quizAct }
        })
      ]
    });
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.Maincontainer}>
          ...
          >
            <View style={{ flex: 1 }}>
              <Text style={[styles.h4, { fontWeight: "bold" }]}>
                Duration: {(this.state.data.quiz_duration / 60) * 1} mins
              </Text>
            </View>
          ...
          <View style={{ width: width(85) }}>
            <Text style={[styles.h4, { fontWeight: "normal" }]}>
              - The test containes single section having 100 questions
            </Text>
            <Text style={[styles.h4, { fontWeight: "normal" }]}>
              - Each questions has 4 options out of which only one is correct
            </Text>
            <Text style={[styles.h4, { fontWeight: "normal" }]}>
            ...
            <Text style={[styles.h4, { fontWeight: "normal" }]}>
              - Try not to guess the answers as there is negative marking
            </Text>
            <Text style={[styles.h4, { fontWeight: "normal" }]}>
              - You will be awarded 1 mark on each correct answer and 0.33 marks
              will be deducted on each wrong answer.
            </Text>
            <Text style={[styles.h4, { fontWeight: "normal" }]}>
              - You can write the test only once
            </Text>
            <Text style={[styles.h4, { fontWeight: "normal" }]}>
              - Make sure you have completed the test before submitting it
            </Text>
            <Text style={[styles.h4, { fontWeight: "normal" }]}>
            ...
            <Text style={[styles.h4, { fontWeight: "normal" }]}>
              - I agree not to cheat or use unfair means in the examination
            </Text>
            <Text style={[styles.h4, { fontWeight: "normal" }]}>
              - I understand that using unfair means of any sort for my own or
              someone else's will lead to my immediate disqualification
            </Text>
          </View>
